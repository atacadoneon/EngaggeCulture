    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {eGestor && (
          <Link
            href="/cultura/criar"
            className="flex items-center gap-2 px-4 py-2.5 bg-violet-600 hover:bg-violet-700 text-white text-sm font-medium rounded-lg transition-colors"
          >
            <Sparkles className="h-4 w-4" />
            Criar Cultura com IA
          </Link>
        )}
      </div>
